...
export const products: Product[] = [
  {
    ...
    available: true,
    description:
      "Gạch granite cao cấp vân đá marble trắng, bề mặt bóng kính, chống trơn trượt. Phù hợp lát phòng khách, sảnh lớn.",
    visible: true,
  },
  {
    id: "p2",
    ...
    available: true,
    description:
      "Gạch men giả gỗ sồi tự nhiên, vân gỗ chân thực. Độ cứng cao, chống mài mòn tốt.",
    visible: true,
  },
  {
    id: "p3",
    ...
    available: true,
    description:
      "Gạch terrazzo phong cách hiện đại, họa tiết đá cuội tự nhiên. Thích hợp cho không gian sang trọng.",
    visible: true,
  },
  {
    id: "p4",
    ...
    available: false,
    description:
      "Gạch lát sân vườn, chống nước, chịu lực tốt. Vân cổ điển Châu Âu.",
    visible: true,
  },
  {
    id: "p5",
    ...
    available: true,
    description:
      "Gạch ốp tường vân đá cẩm thạch, bề mặt nhám. Phù hợp phòng tắm, nhà bếp.",
    visible: true,
  },
  {
    id: "p6",
    ...
    available: true,
    description:
      "Gạch porcelain khổ lớn, màu trắng tinh khiết. Bề mặt siêu bóng, dễ vệ sinh.",
    visible: true,
  },
  {
    id: "p7",
    ...
    available: true,
    description:
      "Gạch mosaic họa tiết vintage, phong cách Địa Trung Hải. Tạo điểm nhấn độc đáo.",
    visible: true,
  },
  {
    id: "p8",
    ...
    available: true,
    description:
      "Gạch granite xám đậm cao cấp, vân đá tự nhiên. Chống trầy xước, bền màu.",
    visible: true,
  },
];
